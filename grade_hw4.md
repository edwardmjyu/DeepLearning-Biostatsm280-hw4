*Yun Han, Juehao Hu, Diyang Wu, Edward Yu, Xinrui Zhang*
...
-   Q2 (25/25)
    -  The `Foodie` app predicts hamburger, mac and cheese, donut, salad and pizza correctly. 
    -  Almonds are predicted as macarons, and bananas as cup cakes. 
...
-   Are there enough commits? Are commit messages clear?
    ...
    Yes. 126 commits on `develop` branch. 
